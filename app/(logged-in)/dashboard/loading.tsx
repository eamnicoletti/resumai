...
import { MotionDiv, MotionH1 } from '@/components/common/motion-warpper'
  ...
  return (
    <div className="flex gap-4 mb-8 justify-between">
      <div className="flex flex-col gap-2">
        ...
        >
          <Skeleton className="h-10 w-48 bg-rose-100" />
        </MotionH1>
        <MotionDiv
          variants={itemVariants}
          initial="hidden"
        ...
        >
          <Skeleton className="h-6 w-96 bg-rose-100" />
        </MotionDiv>
      </div>
      <MotionDiv
        variants={itemVariants}
...
function SummaryCardSkeleton() {
  return (
    ...
    >
      <Skeleton className="h-48 w-full rounded-lg bg-rose-100" />
    </MotionDiv>
  )
}
