...
import { MotionDiv, MotionSection } from '../common/motion-warpper'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <MotionDiv variants={listVariant} className="flex gap-1.5">
          <p className="text-5xl tracking-tight font-extrabold">R$ {price}</p>
          <div className="flex flex-col justify-end mb-[4px]">
            <p className="text-1xl uppercase font-semibold">,00</p>
