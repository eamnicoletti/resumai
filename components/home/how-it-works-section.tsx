...
const steps: Step[] = [
  {
    ...
    label: 'Upload do PDF',
    description: 'Arraste e solte seu documento PDF ou clique em Upload',
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: 'Análise de IA',
    description:
      'Nossa IA avançada processa e analisa seu documento em instantes',
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: 'Resumo Pronto',
    description: 'Receba seu resumo de forma consisa e clara em segundos',
  },
]
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-1155/678 
                    ...
                    sm:left-[cal(40%+30rem)] sm:w-[40.1875rem]"
            style={{
              clipPath:
